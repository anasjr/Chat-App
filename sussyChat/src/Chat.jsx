...
export default function Chat(){
    ...
    function connectToWs(){
        ...
        ws.addEventListener('close',()=> {
            setTimeout(()=>{
                console.log('Disconnected. Hold on while we reconnect');
                connectToWs();
            },1000);
        });
    }
                ...
                <div className="flex-grow">
                    {!selectedUserId && (
                        <div className="flex h-full items-center justify-center">
                            <div className="text-gray-400">&larr; Select someone to start a conversation</div>
                            </div>
                    )}
                    {!!selectedUserId && (
                        ...
                        <div className="overflow-y-scroll absolute top-0 left-0 right-0 bottom-2">
                            {messagesWithoutDups.map(message=>(
                                ...
                                <div className={"text-left inline-block p-2 my-2 rounded-md text-sm " +(message.sender === id ? 'bg-blue-500 text-white':'bg-white text-gray-500')}>
                                    ...
                                    {message.file && (
                                        <div>
                                            <a target="_blank" className="underline" href={axios.defaults.baseURL + '/upload/' + message.file}>
                                                {message.file}
                                            </a>
                                        </div>
                                    )}
